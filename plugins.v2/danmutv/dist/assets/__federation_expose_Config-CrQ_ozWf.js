...
const _hoisted_23 = { class: "text-caption text-grey ml-3" };
...
const _hoisted_32 = { class: "d-flex justify-space-between align-center" };
...
async function handleCleanSubtitles() {
  if (!confirm('确定要清理所有弹幕和合并字幕文件吗？此操作不可恢复。')) {
    return;
  }
  ...
  try {
    const paths = editableConfig.path?.split('\n').filter(p => p.trim()) || [];
    if (paths.length === 0) {
      error.value = '请先设置刮削路径';
      return;
    }
    
    let totalDeleted = 0;
    for (const path of paths) {
      const res = await props.api.get(`plugin/${getPluginId()}/clean_subtitles`, {
        params: { directory_path: path.trim() }
      });
      if (res && res.success && res.data?.deleted) {
        totalDeleted += res.data.deleted.length;
      }
    }
    
    successMessage.value = `成功清理 ${totalDeleted} 个字幕文件`;
  } catch (err) {
    error.value = err?.message || '清理字幕失败';
  } finally {
    saving.value = false;
    setTimeout(() => { successMessage.value = null; error.value = null; }, 4000);
  }
      ...
      default: _withCtx(() => [
        _createVNode(_component_v_card_title, { class: "text-subtitle-1 d-flex align-center px-3 py-2 bg-primary-lighten-5" }, {
          default: _withCtx(() => [
            ...
            _cache[22] || (_cache[22] = _createElementVNode("span", null, "影视弹幕刮削配置", -1))
          ]),
          _: 1
        }),
                                    ...
                                    _createElementVNode("div", _hoisted_16, [
                                      _createElementVNode("div", _hoisted_17, [
                                        ...
                                        _createVNode(_component_v_tooltip, { location: "top" }, {
                                          ...
                                          default: _withCtx(() => [
                                            _cache[28] || (_cache[28] = _createElementVNode("div", { class: "tooltip-content" }, [
                  ...
                  default: _withCtx(() => [
                    _createVNode(_component_v_card_title, { class: "text-caption d-flex align-center px-3 py-2 bg-primary-lighten-5" }, {
                      default: _withCtx(() => [
                        ...
                        _cache[31] || (_cache[31] = _createElementVNode("span", null, "弹幕参数设置", -1))
                      ]),
                      _: 1
                    }),
                    _createVNode(_component_v_card_text, { class: "px-3 py-2" }, {
                                  ...
                                  _createElementVNode("div", _hoisted_20, [
                                    ...
                                    (editableConfig.enable_multi_layer)
                                      ? (_openBlock(), _createElementBlock("div", _hoisted_22, [
                                          _cache[35] || (_cache[35] = _createElementVNode("div", { class: "text-caption text-grey mr-3" }, "弹幕层数", -1)),
                                          _createVNode(_component_v_btn_toggle, {
                                            modelValue: editableConfig.multi_layer_count,
                                            "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((editableConfig.multi_layer_count) = $event)),
                                            modelModifiers: { number: true },
                                            mandatory: "",
                                            density: "compact",
                                            color: "primary",
                                          ...
                                          _createElementVNode("div", _hoisted_23, [
                                            (editableConfig.multi_layer_count === 2)
                                              ? (_openBlock(), _createElementBlock("span", _hoisted_24, "顶层15% / 中层85%"))
                                              : (_openBlock(), _createElementBlock("span", _hoisted_25, "顶层20% / 中层60% / 底层20%"))
                                          ])
                                        ]))
                                      : _createCommentVNode("", true)
                                  ])
                                  ...
                                  _createElementVNode("div", _hoisted_27, [
                                    _createElementVNode("div", _hoisted_28, [
                                      ...
                                      _createVNode(_component_v_switch, {
                                        ...
                                        "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((editableConfig.random_top_bottom) = $event)),
                                        color: "primary",
                                        inset: "",
                                        disabled: saving.value,
                                        density: "compact",
                                    ...
                                    (editableConfig.random_top_bottom)
                                      ? (_openBlock(), _createElementBlock("div", _hoisted_29, [
                                          _createVNode(_component_v_text_field, {
                                            ...
                                            "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((editableConfig.top_ratio) = $event)),
                                            modelModifiers: { number: true },
                                            label: "顶部比例",
                                            type: "number",
                                            density: "compact",
                                          ...
                                          _createVNode(_component_v_text_field, {
                                            ...
                                            "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((editableConfig.bottom_ratio) = $event)),
                                            modelModifiers: { number: true },
                                            label: "底部比例",
                                            type: "number",
                                            density: "compact",
                                  ...
                                  _createElementVNode("div", _hoisted_31, [
                                    _createElementVNode("div", _hoisted_32, [
                                      ...
                                      _createVNode(_component_v_text_field, {
                                        ...
                                        "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((editableConfig.density) = $event)),
                                        modelModifiers: { number: true },
                                        type: "number",
                                        density: "compact",
                                        variant: "outlined",
                                  ...
                                  _createElementVNode("div", _hoisted_34, [
                                    _createElementVNode("div", _hoisted_35, [
                                      ...
                                      _createVNode(_component_v_select, {
                                        ...
                                        "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((editableConfig.width_scale) = $event)),
                                        modelModifiers: { number: true },
                                        density: "compact",
                                        variant: "outlined",
                                        "hide-details": "",
                  ...
                  default: _withCtx(() => [
                    _createVNode(_component_v_card_title, { class: "text-caption d-flex align-center px-3 py-2 bg-primary-lighten-5" }, {
                      default: _withCtx(() => [
                        ...
                        _cache[39] || (_cache[39] = _createElementVNode("span", null, "手动控制媒体库路径", -1))
                      ]),
                      _: 1
                    }),
                    _createVNode(_component_v_card_text, { class: "px-3 py-2" }, {
                      default: _withCtx(() => [
                        _createVNode(_component_v_textarea, {
                          ...
                          "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((editableConfig.path) = $event)),
                          label: "/",
                          variant: "outlined",
                  ...
                  default: _withCtx(() => [
                    _createVNode(_component_v_card_text, { class: "d-flex align-center px-3 py-2" }, {
                      default: _withCtx(() => [
                        ...
                        _cache[40] || (_cache[40] = _createElementVNode("span", { class: "text-caption" }, " 此插件用于生成影视弹幕字幕文件，支持电视剧、电影、动漫等多种媒体类型。弹幕来源为自定义弹幕API后端。 ", -1))
                      ]),
                      _: 1
                    })
                  ]),
        ...
        _createVNode(_component_v_card_actions, { class: "px-2 py-1" }, {
          default: _withCtx(() => [
            _createVNode(_component_v_btn, {
              color: "info",
              onClick: _cache[20] || (_cache[20] = $event => (emit('switch'))),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-85778994"]]);
