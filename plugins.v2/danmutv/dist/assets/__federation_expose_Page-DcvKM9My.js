...
const {resolveComponent:_resolveComponent$5,createVNode:_createVNode$5,createTextVNode:_createTextVNode$5,withCtx:_withCtx$5,toDisplayString:_toDisplayString$4,createElementVNode:_createElementVNode$5,openBlock:_openBlock$5,createElementBlock:_createElementBlock$5,createCommentVNode:_createCommentVNode$4,createBlock:_createBlock$4} = await importShared('vue');


const _hoisted_1$5 = { class: "text-4xl font-bold text-primary" };
const _hoisted_2$4 = { class: "text-4xl font-bold text-success" };
const _hoisted_3$4 = { class: "flex items-center justify-between" };
const _hoisted_4$2 = { class: "text-body-2 font-bold text-success" };
const _hoisted_5$2 = { class: "flex items-center justify-between" };
const _hoisted_6$2 = { class: "text-body-2 font-bold text-warning" };
const _hoisted_7$2 = { class: "flex items-center justify-between" };
const _hoisted_8$2 = { class: "text-body-2 font-bold" };
...
const _hoisted_13$1 = { class: "text-body-2 font-bold" };
const _hoisted_14$1 = { class: "flex items-center justify-between" };
const _hoisted_15$1 = { class: "text-body-2 font-bold" };
const _hoisted_16$1 = { class: "flex items-center justify-between" };
const _hoisted_17$1 = { class: "text-body-2" };
const _hoisted_18$1 = { class: "flex items-center justify-between" };
const _hoisted_19$1 = { class: "text-body-2" };
const _hoisted_20$1 = {
  key: 1,
  class: "text-center text-grey"
};
const _hoisted_21$1 = { class: "flex justify-between mt-2" };
const _hoisted_22$1 = { class: "flex justify-between" };
      ...
      _createVNode$5(_component_v_row, { class: "mb-4" }, {
        default: _withCtx$5(() => [
          _createVNode$5(_component_v_col, { cols: "12" }, {
            default: _withCtx$5(() => [
              _createVNode$5(_component_v_card, { class: "status-card bg-primary-lighten-5" }, {
                default: _withCtx$5(() => [
                  _createVNode$5(_component_v_card_title, { class: "text-h6 font-weight-bold" }, {
                    default: _withCtx$5(() => [
                  ...
                  _createVNode$5(_component_v_card_text, null, {
                    default: _withCtx$5(() => [
                      _createVNode$5(_component_v_row, null, {
                        default: _withCtx$5(() => [
                          _createVNode$5(_component_v_col, {
                            ...
                            default: _withCtx$5(() => [
                              _createVNode$5(_component_v_card, { class: "text-center" }, {
                                default: _withCtx$5(() => [
                                  _createVNode$5(_component_v_card_text, { class: "py-4" }, {
                                    default: _withCtx$5(() => [
                                      _createVNode$5(_component_v_icon, {
                                  ...
                                  _createVNode$5(_component_v_card_title, { class: "text-subtitle-1" }, {
                                    default: _withCtx$5(() => [
                                      _createTextVNode$5(_toDisplayString$4(enabled.value ? '已启用' : '未启用'), 1)
                                    ]),
                                    _: 1
                                  })
                                ]),
                            ...
                            default: _withCtx$5(() => [
                              _createVNode$5(_component_v_card, { class: "text-center" }, {
                                default: _withCtx$5(() => [
                                  ...
                                  _createVNode$5(_component_v_card_title, { class: "text-subtitle-1" }, {
                                    default: _withCtx$5(() => [
                                      _createTextVNode$5(_toDisplayString$4(apiConnected.value ? 'API正常' : 'API异常'), 1)
                                    ]),
                                    _: 1
                                  }),
                                  _createVNode$5(_component_v_card_subtitle, { class: "text-xs text-grey" }, {
                                    default: _withCtx$5(() => [
                                      _createTextVNode$5(_toDisplayString$4(apiMessage.value), 1)
                                    ]),
                                    _: 1
                                  })
                                ]),
                            ...
                            default: _withCtx$5(() => [
                              _createVNode$5(_component_v_card, { class: "text-center" }, {
                                default: _withCtx$5(() => [
                                  _createVNode$5(_component_v_card_text, { class: "py-4" }, {
                                    default: _withCtx$5(() => [
                                      _createElementVNode$5("span", _hoisted_1$5, _toDisplayString$4(stats.value.total_files), 1)
                                    ]),
                                    _: 1
                                  }),
                                  _createVNode$5(_component_v_card_title, { class: "text-subtitle-1" }, {
                                    default: _withCtx$5(() => [...(_cache[1] || (_cache[1] = [
                                      _createTextVNode$5("总文件数", -1)
                                    ]))]),
                                    _: 1
                                  })
                                ]),
                            ...
                            default: _withCtx$5(() => [
                              _createVNode$5(_component_v_card, { class: "text-center" }, {
                                default: _withCtx$5(() => [
                                  _createVNode$5(_component_v_card_text, { class: "py-4" }, {
                                    default: _withCtx$5(() => [
                                      _createElementVNode$5("span", _hoisted_2$4, _toDisplayString$4(stats.value.retry_tasks_count), 1)
                                    ]),
                                    _: 1
                                  }),
                                  _createVNode$5(_component_v_card_title, { class: "text-subtitle-1" }, {
                                    default: _withCtx$5(() => [...(_cache[2] || (_cache[2] = [
                                      _createTextVNode$5("重试任务", -1)
                                    ]))]),
                                    _: 1
                                  })
                                ]),
                ...
                default: _withCtx$5(() => [
                  _createVNode$5(_component_v_card_title, { class: "text-h6 font-weight-bold" }, {
                    default: _withCtx$5(() => [
                      ...
                      _cache[3] || (_cache[3] = _createTextVNode$5(" 统计信息 ", -1))
                    ]),
                    _: 1
                  }),
                  _createVNode$5(_component_v_card_text, null, {
                          ...
                          _createVNode$5(_component_v_col, {
                            ...
                            default: _withCtx$5(() => [
                              _createElementVNode$5("div", _hoisted_3$4, [
                                _cache[4] || (_cache[4] = _createElementVNode$5("span", { class: "text-body-1" }, "成功刮削", -1)),
                                _createElementVNode$5("span", _hoisted_4$2, _toDisplayString$4(stats.value.success_count), 1)
                              ]),
                          ...
                          _createVNode$5(_component_v_col, {
                            ...
                            default: _withCtx$5(() => [
                              _createElementVNode$5("div", _hoisted_5$2, [
                                _cache[5] || (_cache[5] = _createElementVNode$5("span", { class: "text-body-1" }, "失败/重试", -1)),
                                _createElementVNode$5("span", _hoisted_6$2, _toDisplayString$4(stats.value.failed_count), 1)
                              ]),
                              _createVNode$5(_component_v_progress_linear, {
                          ...
                          _createVNode$5(_component_v_col, {
                            ...
                            default: _withCtx$5(() => [
                              _createElementVNode$5("div", _hoisted_7$2, [
                                _cache[6] || (_cache[6] = _createElementVNode$5("span", { class: "text-body-1" }, "成功率", -1)),
                                _createElementVNode$5("span", _hoisted_8$2, _toDisplayString$4(stats.value.total_files > 0 ? Math.round(stats.value.success_count / stats.value.total_files * 100) : 0) + "%", 1)
                              ]),
                              _createVNode$5(_component_v_progress_linear, {
                                value: stats.value.total_files > 0 ? (stats.value.success_count / stats.value.total_files * 100) : 0,
                                color: "primary",
                ...
                default: _withCtx$5(() => [
                  _createVNode$5(_component_v_card_title, { class: "text-h6 font-weight-bold" }, {
                    default: _withCtx$5(() => [
                      ...
                      _cache[7] || (_cache[7] = _createTextVNode$5(" 计划任务 ", -1))
                    ]),
                    _: 1
                  }),
                  _createVNode$5(_component_v_card_text, null, {
                          ...
                          _createVNode$5(_component_v_col, { cols: "12" }, {
                            default: _withCtx$5(() => [
                              _createElementVNode$5("div", _hoisted_9$1, [
                                _cache[8] || (_cache[8] = _createElementVNode$5("span", { class: "text-body-1" }, "下次重试时间", -1)),
                                (nextRetryTime.value)
                                  ? (_openBlock$5(), _createElementBlock$5("span", _hoisted_10$1, _toDisplayString$4(nextRetryTime.value), 1))
                                  : (_openBlock$5(), _createElementBlock$5("span", _hoisted_11$1, "暂无重试任务"))
                              ])
                            ]),
                            _: 1
                          }),
                            ...
                            default: _withCtx$5(() => [
                              _createVNode$5(_component_v_btn, {
                                ...
                                default: _withCtx$5(() => [
                                  ...
                                  _cache[9] || (_cache[9] = _createTextVNode$5(" 立即重试 ", -1))
                                ]),
                                _: 1
                              })
                            ]),
                ...
                default: _withCtx$5(() => [
                  _createVNode$5(_component_v_card_title, { class: "text-h6 font-weight-bold" }, {
                    default: _withCtx$5(() => [
                      ...
                      _cache[10] || (_cache[10] = _createTextVNode$5(" 最近运行 ", -1))
                    ]),
                    _: 1
                  }),
                  _createVNode$5(_component_v_card_text, null, {
                      ...
                      (lastRun.value)
                        ? (_openBlock$5(), _createBlock$4(_component_v_row, { key: 0 }, {
                            default: _withCtx$5(() => [
                              _createVNode$5(_component_v_col, { cols: "12" }, {
                                default: _withCtx$5(() => [
                                  _createElementVNode$5("div", _hoisted_12$1, [
                                    _cache[11] || (_cache[11] = _createElementVNode$5("span", { class: "text-body-1" }, "时间", -1)),
                                    _createElementVNode$5("span", _hoisted_13$1, _toDisplayString$4(formatTime(lastRun.value.timestamp)), 1)
                                  ])
                                ]),
                                _: 1
                              }),
                              _createVNode$5(_component_v_col, { cols: "12" }, {
                                default: _withCtx$5(() => [
                                  _createElementVNode$5("div", _hoisted_14$1, [
                                    _cache[12] || (_cache[12] = _createElementVNode$5("span", { class: "text-body-1" }, "类型", -1)),
                                    _createElementVNode$5("span", _hoisted_15$1, _toDisplayString$4(getTypeLabel(lastRun.value.type)), 1)
                                  ])
                                ]),
                                _: 1
                              }),
                              _createVNode$5(_component_v_col, { cols: "12" }, {
                                default: _withCtx$5(() => [
                                  _createElementVNode$5("div", _hoisted_16$1, [
                                    _cache[13] || (_cache[13] = _createElementVNode$5("span", { class: "text-body-1" }, "结果", -1)),
                                    _createElementVNode$5("span", _hoisted_17$1, "成功 " + _toDisplayString$4(lastRun.value.success) + " / 失败 " + _toDisplayString$4(lastRun.value.failed), 1)
                                  ])
                                ]),
                                _: 1
                              }),
                              _createVNode$5(_component_v_col, { cols: "12" }, {
                                default: _withCtx$5(() => [
                                  _createElementVNode$5("div", _hoisted_18$1, [
                                    _cache[14] || (_cache[14] = _createElementVNode$5("span", { class: "text-body-1" }, "耗时", -1)),
                                    _createElementVNode$5("span", _hoisted_19$1, _toDisplayString$4(formatDuration(lastRun.value.duration)), 1)
                                  ])
                                ]),
                                _: 1
                              })
                        ...
                        : (_openBlock$5(), _createElementBlock$5("div", _hoisted_20$1, " 暂无运行记录 "))
                    ]),
                    _: 1
                  })
                ]),
                    ...
                    default: _withCtx$5(() => [
                      _createVNode$5(_component_v_card_title, { class: "text-h6 font-weight-bold" }, {
                        default: _withCtx$5(() => [
                          ...
                          _cache[15] || (_cache[15] = _createTextVNode$5(" 正在刮削中 ", -1))
                        ]),
                        _: 1
                      }),
                      _createVNode$5(_component_v_card_text, null, {
                        default: _withCtx$5(() => [
                          ...
                          _createElementVNode$5("div", _hoisted_21$1, [
...
const {ref: ref$3,computed,onMounted: onMounted$2} = await importShared('vue');
  ...
  return (_openBlock$3(), _createBlock$2(_component_v_container, {
    ...
    default: _withCtx$3(() => [
      _createVNode$3(_component_v_card, null, {
        default: _withCtx$3(() => [
          _createVNode$3(_component_v_card_title, { class: "text-h6 font-weight-bold" }, {
            default: _withCtx$3(() => [
  ...
  return (_openBlock$2(), _createBlock$1(_component_v_container, {
    ...
    default: _withCtx$2(() => [
      _createVNode$2(_component_v_card, null, {
        default: _withCtx$2(() => [
          _createVNode$2(_component_v_card_title, { class: "text-h6 font-weight-bold" }, {
            default: _withCtx$2(() => [
  ...
  return (_openBlock$1(), _createBlock(_component_v_container, {
    ...
    default: _withCtx$1(() => [
      _createVNode$1(_component_v_card, null, {
        default: _withCtx$1(() => [
          _createVNode$1(_component_v_card_title, { class: "text-h6 font-weight-bold" }, {
            default: _withCtx$1(() => [
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-43da1d0f"]]);
